...
import com.assignment.solutions.Bird;
import com.assignment.solutions.Butterfly;
import com.assignment.solutions.Cat;
import com.assignment.solutions.Chicken;
import com.assignment.solutions.Clownfish;
import com.assignment.solutions.Dog;
import com.assignment.solutions.Dolphin;
import com.assignment.solutions.Duck;
import com.assignment.solutions.Fish;
import com.assignment.solutions.Frog;
import com.assignment.solutions.Parrot;
import com.assignment.solutions.Rooster;
import com.assignment.solutions.Shark;
...
class SolutionTest {
    ...
    void fly() {
        ...
        new Butterfly().canFly();
        assertThat(outContent.toString(), containsString("I can't Fly"));
    ...
    void sing() {
        ...
        new Chicken(new Helper(Sound.CHICKEN)).callSound();
        assertThat(outContent.toString(), containsString("Cluck, cluck"));
        ...
        new Dog(new Helper(Sound.DOG)).callSound();
        assertThat(outContent.toString(), containsString("Woof, woof"));
        new Cat(new Helper(Sound.CAT)).callSound();
        assertThat(outContent.toString(), containsString("Meow"));

        new Parrot().callSound();
        assertThat(outContent.toString(), containsString("I am singing"));
        new Parrot(new Helper(Sound.DOG)).callSound();
        assertThat(outContent.toString(), containsString("Woof, woof"));
        new Parrot(new Helper(Sound.CAT)).callSound();
        assertThat(outContent.toString(), containsString("Meow"));
        new Parrot(new Helper(Sound.ROOSTER)).callSound();
        assertThat(outContent.toString(), containsString("Cock-a-doodle-doo"));
